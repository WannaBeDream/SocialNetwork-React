...
const usersReducer = (state = initialState, action) => {
    switch (action.type) {
        case FOLLOW_FRIEND:
            return {
                ...state,
                users: UpdateObjectInArray(state.users, action.userId, "id", { followerd: true })
        ...
        case UNFOLLOW_FRIEND:
            return {
                ...state,
                users: UpdateObjectInArray(state.users, action.userId, "id", { followerd: false })
            };
        case SET_USERS: {
...
export const followSuccess = (userId) => ({ type: FOLLOW_FRIEND, userId });
export const unfollowSuccess = (userId) => ({ type: UNFOLLOW_FRIEND, userId });
